...
public class PillCounterBeginTest {
  ...
  @Test
  public void usage() {
    PillCounter c = new LoggingPillCounter();
    PillCounter counter = new LazyAddPills(c);
  ...
  public void usage2() {
    PillCounter c = new LoggingPillCounter();
    PillCounter counter = new LoggingPillDecorator(c);
    System.out.println(((LoggingPillDecorator) counter).printCount());
    boolean result = conveyerBelt(counter);
    assertTrue(result);
  }
}